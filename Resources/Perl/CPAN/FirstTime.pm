...
{
    my %shell_rc_map = (
        map { $_ => "Documents/.${_}rc" } qw/ bash tcsh csh /,
        map { $_ => "Documents/.profile" } qw/dash ash sh/,
        zsh  => "Documents/.zshenv",
    );
...
sub _local_lib_path {
    return File::Spec->catdir(_local_lib_home(), 'Documents/perl5');
}
